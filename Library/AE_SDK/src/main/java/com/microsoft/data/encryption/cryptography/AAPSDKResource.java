...
public final class AAPSDKResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS = {
            ...
            {"R_InvalidDataEncryptionKey", "DataEncryptionKey name cannot be null or empty or consist of only whitespace."},
            {"R_InvalidKeySize", "key must contain {0} elements."},
            {"R_IllegalOffset", "Illegal offset minutes."},
            ...
            {"R_InvalidKeyStorePath", "System cannot find the key store file at the specified path. Verify that the path is correct and you have proper permissions to access it."},
            {"R_InvalidFileFormat", "Cannot parse \"{0}\". Either the file format is not valid or the password is not correct."},
            ...
            {"R_CEKSignatureNotMatchCMK", "The specified encrypted column encryption key signature does not match the signature computed with the column master key (certificate) in \"{0}\". The encrypted column encryption key may be corrupt, or the specified path may be incorrect."},
            ...
            {"R_UnexpectedSSType", "Unexpected SSType: {0}."},
            {"R_UnexpectedJDBCType", "Unexpected JDBCType: {0}."},
            {"R_InvalidTemporalValue", "Invalid temporal value provided."},
            {"R_KeystoreProviderError", "An error has occured while getting keystore provider."},
            {"R_CannotBeNull", "{0} cannot be null."},
            {"R_CannotBeNullOrWhiteSpace", "{0} cannot be null or empty."},
            {"R_InvalidPSLength", "Value ''{0}'' of type {1} is invalid for the expected precision of {2} and scale of {3}."},
