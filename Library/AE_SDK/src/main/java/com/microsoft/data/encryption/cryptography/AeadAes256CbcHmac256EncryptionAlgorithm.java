...
public class AeadAes256CbcHmac256EncryptionAlgorithm extends DataProtector {
    ...
    private static Map<Tuple<DataEncryptionKey, EncryptionType>, AeadAes256CbcHmac256EncryptionAlgorithm> algorithmCache
        = new ConcurrentHashMap<Tuple<DataEncryptionKey, EncryptionType>, AeadAes256CbcHmac256EncryptionAlgorithm>();

    /**
     * Retrieves existing AeadAes256CbcHmac256EncryptionAlgorithm or creates a new AeadAes256CbcHmac256EncryptionAlgorithm.
     ...
     */
    public static AeadAes256CbcHmac256EncryptionAlgorithm getOrCreate(DataEncryptionKey dataEncryptionKey, EncryptionType encryptionType) throws AAPSDKException
    {
