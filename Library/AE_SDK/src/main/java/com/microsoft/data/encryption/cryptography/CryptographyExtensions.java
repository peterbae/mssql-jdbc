...
public final class CryptographyExtensions {
     ...
     * @param encryptionKey encryption key to be used
     * @param typeParameter type of serializer to be used
     ...
     * @param plaintext plaintext data
     * @param encryptionSettings encryption settings
     * @return encrpyted byte array
     * @throws AAPSDKException
     */
    public static <T> byte[] encrypt(T plaintext, EncryptionSettingsImpl<T> encryptionSettings) throws AAPSDKException {
     ...
     * @throws AAPSDKException
     */
    public static <T> T decrypt(byte[] ciphertext, EncryptionSettingsImpl<T> encryptionSettings) throws AAPSDKException {
        if (null == encryptionSettings) {
            throw new AAPSDKException(AAPSDKResource.getResource("R_NullEncryptionSettings"));
        }
    ...
    /**
     * Encrypts given plaintext according to the specified type.
     * @param source iterable plaintext data source
     * @param encryptionKey encryption key to be used
     * @param typeParameter type of serializer to be used
    ...
    /**
     * Decrypts given ciphertext according to the specified type.
     * @param source iterable ciphertext data source
     * @param encryptionKey encryption key to be used
     * @param typeParameter type of serializer to be used
     ...
     * @param source iterable data source
     * @param encryptionSettings encryption settings
     * @return Iterable containing encrpyted byte array
     * @throws AAPSDKException
     */
    public static <T> Iterable<byte[]> encrypt(Iterable<T> source,
            EncryptionSettingsImpl<T> encryptionSettings) throws AAPSDKException {
        if (null == encryptionSettings) {
            throw new AAPSDKException(AAPSDKResource.getResource("R_NullEncryptionSettings"));
        }
     ...
     * @param source An array of bytes.
    ...
    /**
     * Converts each byte array in the source sequence to its equivalent string representation that is encoded with base-64 digits.
     * @param source A sequence of byte arrays to convert.
     ...
     * @param source A sequence of strings to convert.
     ...
     * @param source An array of bytes to convert.
    ...
    /**
     * Converts each byte array in the source sequence to its equivalent string representation that is encoded with hexidecimal digits.
     * @param source A sequence of byte arrays to convert.
    ...
    /**
     * Converts each String element of source, which encodes binary data as hexidecimal digits, to an equivalent byte array.
     * @param source A sequence of strings to convert.
     * @return An Iterable of byte arrays that is equivalent to source.
     */
