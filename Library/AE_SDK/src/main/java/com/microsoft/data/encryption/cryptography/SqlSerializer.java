...
class SqlBinarySerializer extends SqlSerializer {
    ...
    public SqlBinarySerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
            MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_parameterOutOfRange"));
...
class SqlCharSerializer extends SqlSerializer {
    ...
    public SqlCharSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
...
class SqlDateTime2Serializer extends SqlSerializer {
    ...
    public SqlDateTime2Serializer(int size, int precision, int scale) {
        if (precision == 0) {
...
class SqlDateTimeOffsetSerializer extends SqlSerializer {
    ...
    public SqlDateTimeOffsetSerializer(int size, int precision, int scale) {
        if (precision == 0) {
            precision = defaultPrecision;
        }
        if (precision < minPrecision || precision > maxPrecision) {
...
class SqlDecimalSerializer extends SqlSerializer {
    ...
    public SqlDecimalSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (precision == 0) {
            precision = defaultPrecision;
        }
...
class SqlNCharSerializer extends SqlSerializer {
    ...
    public SqlNCharSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
...
class SqlNVarcharSerializer extends SqlSerializer {
    ...
    public SqlNVarcharSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
...
class SqlNumericSerializer extends SqlSerializer {
    ...
    public SqlNumericSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (precision == 0) {
            precision = defaultPrecision;
        }
...
class SqlVarbinarySerializer extends SqlSerializer {
    ...
    public SqlVarbinarySerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
...
class SqlVarcharSerializer extends SqlSerializer {
    ...
    public SqlVarcharSerializer(int size, int precision, int scale) throws AAPSDKException {
        if (size == 0) {
            size = defaultSize;
        }
        if (size < minSize || size > maxSize) {
