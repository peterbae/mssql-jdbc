...
public class testSQLSerializer extends AESetup {
    ...
    public void testBigInteger() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.BIGINT.name(), 0, 0, 0);
    ...
    public void testBinary() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.BINARY.name(), 5, 0, 0);
    ...
    public void testBoolean() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.BIT.name(), 0, 0, 0);
    ...
    public void testCharacter() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.CHAR.name(), 25, 0, 0);
    ...
    public void testDate() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DATE.name(), 0, 0, 0);
    ...
    public void testDateTime2() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DATETIME2.name(), 0, 0, 3);
    ...
    public void testDateTimeOffset() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DATETIMEOFFSET.name(), 0, 0, 3);
    ...
    public void testDateTime() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DATETIME.name(), 0, 0, 0);
    ...
    public void testDecimal() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DECIMAL.name(), 0, 19, 4);
    ...
    public void testDecimalWithDriver() throws AAPSDKException {
        ...
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.DECIMAL.name(), 0, 38, 4);
    ...
    public void testFloat() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.FLOAT.name(), 0, 0, 0);
    ...
    public void testInteger() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.INTEGER.name(), 0, 0, 0);
    ...
    public void testMoney() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.MONEY.name(), 0, 32, 0);
    ...
    public void testNChar() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.NCHAR.name(), 10, 0, 0);
    ...
    public void testNVarchar() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.NVARCHAR.name(), 40, 0, 0);
    ...
    @Test
    public void testNumeric() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.NUMERIC.name(), 0, 19, 4);
        BigDecimal[] dataArray = {null, new BigDecimal(Long.MIN_VALUE), new BigDecimal(Long.MAX_VALUE),
                new BigDecimal(0L), new BigDecimal(1000000000L), new BigDecimal(-1000000000L),};
        for (BigDecimal data : dataArray) {
            byte[] serializedData = serializer.serialize(data);
    ...
    @Test
    public void testNumericWithDriver() throws AAPSDKException {
        String type = "numeric(38, 4)";
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.NUMERIC.name(), 0, 38, 4);
        BigDecimal[] dataArray = {new BigDecimal(Long.MIN_VALUE), new BigDecimal(Long.MAX_VALUE), new BigDecimal(0L),
                new BigDecimal(1000000000L), new BigDecimal(-1000000000L),};
        try {
            createTable(type);
    ...
    public void testReal() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.REAL.name(), 0, 0, 0);
    ...
    public void testSmalldatetime() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.SMALLDATETIME.name(), 0, 0, 0);
        java.sql.Timestamp[] dataArray = {null, new java.sql.Timestamp(0L), new java.sql.Timestamp(1600991197216L)};
    ...
    public void testSmallInt() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.SMALLINT.name(), 0, 0, 0);
    ...
    public void testSmallmoney() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.SMALLMONEY.name(), 0, 5, 0);
    ...
    public void testTime() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.TIME.name(), 0, 0, 0);
    ...
    public void testTinyint() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.TINYINT.name(), 0, 0, 0);
    ...
    public void testUniqueidentifier() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.GUID.name(), 0, 40, 0);
    ...
    public void testVarbinary() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.VARBINARY.name(), 400, 0, 0);
    ...
    public void testVarchar() throws AAPSDKException {
        ISerializer serializer = SqlSerializerFactory.getOrCreate(SSType.VARCHAR.name(), 17, 0, 0);
