...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {
        ...
        {"R_tcpipConnectionFailed", "The TCP/IP connection to the host {0}, port {1} has failed. Error: \"{2}\"."},
        ...
        {"R_invalidKeyStoreFile", "Cannot parse \"{0}\". Either the file format is not valid or the password is not correct."},
        ...
        {"R_sqlServerHoldability", "SQL Server supports holdability at the connection level only. Use the connection.setHoldability() method."},
        ...
        {"R_InvalidAEVersionNumber", "Received invalid version number \"{0}\" for Always Encrypted."},
